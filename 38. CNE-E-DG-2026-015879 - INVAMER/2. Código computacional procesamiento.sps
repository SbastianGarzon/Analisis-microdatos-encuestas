...
DATASET CLOSE * .
GET FILE='C:\Diana\2026\OPINIÓN\009200260000 COLOMBIA OPINA No 21\PROCESAMIENTO\Data SPSS\009200260000 COLOMBIA OPINA No 21 Tendencias.sav' .
...
INSERT FILE = 'C:\Diana\2026\OPINIÓN\009200260000 COLOMBIA OPINA No 21\PROCESAMIENTO\Sintaxis\4_0_009200260000_Nets.sps' .
...
CTABLES
  ...
  /CATEGORIES VARIABLES = F_TENDENCIA [202604]                          EMPTY = INCLUDE
...
CTABLES
  ...
  /TABLE
   ...
   BY F_TENDENCIA > (B_TOTAL [C])
  /SLABELS POSITION=ROW                             VISIBLE=YES
  /CATEGORIES VARIABLES=!VarCat [SUBTOTAL ='  SI VOTÓ',1,2,3,4,999, HSUBTOTAL ='  NO VOTÓ/ NO SABE',1000]   EMPTY=EXCLUDE TOTAL=NO  LABEL='TOTAL' POSITION=BEFORE
  /CATEGORIES VARIABLES=!CONCAT ("R",!VarCat) [OTHERNM, HSUBTOTAL=' '] EMPTY=EXCLUDE TOTAL=NO LABEL=' ' POSITION=AFTER
  /CATEGORIES VARIABLES = F_TENDENCIA [202604]                          EMPTY = INCLUDE
  /CATEGORIES VARIABLES = B_TOTAL  EMPTY=INCLUDE
  /TITLES
...
@MULT_RESP_BASE    VarCat = P245 	/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P247 		/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P240 		/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P271 		/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P272 		/SubTítulo= ' ' 'Base: Total Encuestados' .
...
@UNI_RESP_BASE    VarCat = P258 		/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P267 		/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P268 		/SubTítulo= ' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_256      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_258      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_259      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_260      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_261      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_262      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_263      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_264      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_265      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
@UNI_RESP_NET    VarCat = P5A_255      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
@UNI_RESP_NET    VarCat = P5A_266      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_267      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .
...
@UNI_RESP_NET    VarCat = P5A_268      	/Título='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?.' ' '/SubTítulo=' ' 'Base: Total Encuestados' .


USE ALL.
COMPUTE filter_$=(F_TENDENCIA = 202604).
FILTER BY filter_$.
EXECUTE .

@RESUMEN_CAT      Var= P5A_50 P5A_256 P5A_11 P5A_258 P5A_110 P5A_259 P5A_97 P5A_260 P5A_98 P5A_261 P5A_104 P5A_262 P5A_113 P5A_263 P5A_27 
                                                 P5A_264 P5A_95 P5A_265 P5A_255 P5A_266 P5A_30 P5A_88 P5A_3 P5A_267 P5A_65 P5A_268
		/ESTAD=ROWPCT.TOTALN     /CAT=SUBTOTAL ='  SI LO(A) CONOCE',1,2,999, HSUBTOTAL ='  NO LO(A) CONOCE',4
		/Titulo='P5A. ¿Conoce usted o ha oído mencionar a ___. ¿Tiene usted una opinión favorable o desfavorable de esta persona?'  	'' 'CUADRO RESUMEN' '' 'Base: Total Encuestados'.

FILTER OFF.


@UNI_RESP_BASE    VarCat = P266 		/SubTítulo= ' ' 'Base: Total Encuestados' .
...
@MULTIPLENET  	  Var = P260	/Cat = P4_OTRO  /SubTitulo = ' ' 'Base: Total Encuestados' .
...
@UNI_RESP_BASE    VarCat = P273  	/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P262  	/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P261  	/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P263  	/SubTítulo= ' ' 'Base: Total Encuestados' .

@UNI_RESP_BASE    VarCat = P264  	/SubTítulo= ' ' 'Base: Total Encuestados' .
...
OUTPUT SAVE
 OUTFILE = 'C:\Diana\2026\OPINIÓN\009200260000 COLOMBIA OPINA No 21\PROCESAMIENTO\Informe 1_009200260000 COLOMBIA OPINA No 21_Informe principal.spv' .

OUTPUT EXPORT
  /CONTENTS  EXPORT=VISIBLE  LAYERS=PRINTSETTING  MODELVIEWS=PRINTSETTING
  /XLSX  DOCUMENTFILE='C:\Diana\2026\OPINIÓN\009200260000 COLOMBIA OPINA No 21\RESULTADOS\Informe 1_009200260000 COLOMBIA OPINA No 21.xlsx'
...
OUTPUT SAVE
 OUTFILE = 'C:\Diana\2026\OPINIÓN\009200260000 COLOMBIA OPINA No 21\PROCESAMIENTO\Informe 1_009200260000 COLOMBIA OPINA No 21_Victimización.spv' .
